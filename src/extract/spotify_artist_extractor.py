...
def extract_spotify_artist_metrics(artist_id):
    ...
    try:
        ...
        print(artists)
        required_fields= ['artist_id', 'popularity', 'follower_count', 'source']
...
if __name__=='__main__':
    ...
    try:
        ...
        artist_ids = [artist_id[0] for artist_id in artist_id_list]
        ...
        with ProcessPoolExecutor(max_workers=max_workers) as w:
            futures = {w.submit(extract_spotify_artist_metrics, artist_id): artist_id for artist_id in artist_ids}
