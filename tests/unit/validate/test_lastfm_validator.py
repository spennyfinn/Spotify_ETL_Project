...
from tests.unit.constants import (
    INVALID_ID_IDS, INVALID_IDS,VALID_BOOLEAN_VALUES,
    VALID_ID_VALUES, VALID_ID_VALUES_IDS, WRONG_BOOLEAN_TYPES, WRONG_BOOLEAN_TYPES_IDS,
    ...
    INVALID_CALCULATED_FIELD_VALUES_IDS
)
...
class TestLastFmData():
    ...
    def test_valid_song_names(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_song_names(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['song_name'] = value
    ...
    def test_invalid_types_song_names(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['song_name'] = value
    ...
    def test_valid_artist_names(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    @pytest.mark.parametrize('value', EMPTY_STRINGS, ids=EMPTY_STRINGS_IDS)
    def test_invalid_artist_names(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['artist_name'] = value
    ...
    @pytest.mark.parametrize('value', WRONG_STRING_TYPE, ids=WRONG_STRING_TYPE_IDS)
    def test_invalid_types_artist_names(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['artist_name'] = value
    ...
    def test_valid_song_ids(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_song_ids(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['song_id'] = value
    ...
    @pytest.mark.parametrize('value', WRONG_STRING_TYPE,ids=WRONG_STRING_TYPE_IDS)
    def test_invalid_types_song_ids(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['song_id'] = value
    ...
    #ARTIST IDS
    @pytest.mark.parametrize('value', VALID_ID_VALUES, ids=VALID_ID_VALUES_IDS)
    def test_valid_artist_ids(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    @pytest.mark.parametrize('value', INVALID_IDS, ids=INVALID_ID_IDS)
    def test_invalid_artist_ids(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['artist_id'] = value
    ...
    @pytest.mark.parametrize('value', WRONG_STRING_TYPE,ids=WRONG_STRING_TYPE_IDS)
    def test_invalid_types_artist_ids(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['artist_id'] = value
    ...
    def test_valid_mbid(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_mbid(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['mbid'] = value
    ...
    def test_invalid_types_mbid(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['mbid'] = value
    ...
    def test_valid_on_tour(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_types_on_tour(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['on_tour'] = value
    ...
    def test_valid_er(self, valid_lastfm_data, value_ppl, value_total_listeners, value_total_playcount, value_er, value_song_listeners):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_er(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_types_er(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['engagement_ratio'] = value
    ...
    #PLAYS PER LISTENER
    @pytest.mark.parametrize('value_ppl,value_total_listeners,value_total_playcount,value_er,value_song_listeners', VALID_CALCULATED_FIELD_VALUES, ids=VALID_CALCULATED_FIELD_VALUES_IDS)
    def test_valid_ppl(self, valid_lastfm_data, value_ppl, value_total_listeners, value_total_playcount, value_er, value_song_listeners):
        test_data = valid_lastfm_data.copy()
        test_data['artist_total_playcount'] = value_total_playcount
        test_data['artist_total_listeners'] = value_total_listeners
        test_data['plays_per_listener'] = value_ppl
    ...
    def test_invalid_ppl(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_types_ppl(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['plays_per_listener'] = value
        with pytest.raises(TypeError, match='plays_per_listener'):
            LastFmData(**test_data)

    def test_return_zero_ppl(self, valid_lastfm_data):
        test_data = valid_lastfm_data.copy()
    ...
    def test_valid_song_listeners(self, valid_lastfm_data, value_ppl, value_total_listeners, value_total_playcount, value_er, value_song_listeners):
        test_data = valid_lastfm_data.copy()
        test_data['artist_total_playcount'] = value_total_playcount
        test_data['artist_total_listeners'] = value_total_listeners
        test_data['plays_per_listener'] = value_ppl
    ...
    def test_invalid_song_listeners(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_types_song_listeners(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['num_song_listeners'] = value
    ...
    @pytest.mark.parametrize('value_ppl,value_total_listeners,value_total_playcount,value_er,value_song_listeners', VALID_SONG_LISTENERS_VALUES, ids=VALID_SONG_LISTENERS_VALUES_IDS)
    def test_valid_artist_total_playcount(self, valid_lastfm_data, value_ppl, value_total_listeners, value_total_playcount, value_er, value_song_listeners):
        test_data = valid_lastfm_data.copy()
        test_data['artist_total_playcount'] = value_total_playcount
        test_data['artist_total_listeners'] = value_total_listeners
        test_data['plays_per_listener'] = value_ppl
    ...
    @pytest.mark.parametrize('value', INVALID_NEGATIVE_INT_VALUES, ids=INVALID_NEGATIVE_INT_VALUES_IDS)
    def test_invalid_artist_total_playcount(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    @pytest.mark.parametrize('value', WRONG_INT_TYPE, ids=WRONG_INT_TYPE_IDS)
    def test_invalid_types_artist_total_playcount(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['artist_total_playcount'] = value
    ...
    @pytest.mark.parametrize('value_ppl,value_total_listeners,value_total_playcount,value_er,value_song_listeners', VALID_SONG_LISTENERS_VALUES, ids=VALID_SONG_LISTENERS_VALUES_IDS)
    def test_valid_artist_total_listeners(self, valid_lastfm_data, value_ppl, value_total_listeners, value_total_playcount, value_er, value_song_listeners):
        test_data = valid_lastfm_data.copy()
        test_data['artist_total_playcount'] = value_total_playcount
        test_data['artist_total_listeners'] = value_total_listeners
        test_data['plays_per_listener'] = value_ppl
    ...
    @pytest.mark.parametrize('value', INVALID_NEGATIVE_INT_VALUES, ids=INVALID_NEGATIVE_INT_VALUES_IDS)
    def test_invalid_artist_total_listeners(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
    ...
    @pytest.mark.parametrize('value', WRONG_INT_TYPE, ids=WRONG_INT_TYPE_IDS)
    def test_invalid_types_artist_total_listeners(self, valid_lastfm_data, value):
        test_data = valid_lastfm_data.copy()
        test_data['artist_total_listeners'] = value
    ...
    def test_valid_calculated_fields(self, valid_lastfm_data, listeners, playcount, song_listeners, ppl, er):
        test_data = valid_lastfm_data.copy()
    ...
    def test_invalid_calculated_fields(self, valid_lastfm_data, ppl, listeners, playcount, er, song_listeners):
        test_data = valid_lastfm_data.copy()
        test_data['artist_total_playcount'] = playcount
        test_data['artist_total_listeners'] = listeners
        test_data['plays_per_listener'] = ppl
